...
public class QueryController
{
    ...
    {
        final RoomMessagesQuery query = new RoomMessagesQuery(roomId);
        final SubscriptionQueryResult<List<ChatMessage>, ChatMessage> result;
        ...
        final Flux<ChatMessage> initialResult = result.initialResult().flatMapMany(Flux::fromIterable);
